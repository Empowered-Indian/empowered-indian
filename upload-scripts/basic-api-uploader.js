...
console.log(
  '📄 Creates basic collections: mps, expenditures, works_completed, works_recommended, summaries'
)
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n')
...
syncMPLADSDataFromAPI()
  .then(() => {
    ...
    console.log(
      '🗂️  Collections created: mps, expenditures, works_completed, works_recommended, summaries'
    )
    process.exit(0)
  })
  .catch(error => {
