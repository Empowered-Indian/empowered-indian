...
const FilterPanel = ({ onClose, isMobile: propIsMobile = false }) => {
  ...
  const validateUtilization = useCallback(
    (value, field) => {
  ...
  const handleUtilizationRangeChange = useCallback(
    range => {
  ...
  return (
    <div
      className={`filter-panel ${isMobile ? 'filter-panel-mobile' : ''} ${isClosing ? 'filter-panel-closing' : ''}`}
    >
              ...
              <div className="filter-section-content">
                <div className="filter-group">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateFilter('state', value === 'all-states' ? '' : value)
                    }
                    disabled={loading.states}
                  >
                    <SelectTrigger>
                      <SelectValue
                        placeholder={loading.states ? 'Loading states...' : 'All States'}
                      />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="filter-section-content">
                <div className="filter-group">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateFilter('workStatus', value === 'all-status' ? '' : value)
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="filter-group">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateFilter('sector', value === 'all-sectors' ? '' : value)
                    }
                  >
                    <SelectTrigger>
                  ...
                  <div className="range-inputs">
                    <div className="input-wrapper">
                      <Select
                        ...
                        onValueChange={value =>
                          handleYearChange('yearFrom', value === 'year-from' ? '' : value)
                        }
                      >
                        <SelectTrigger
                          className={
                            validationErrors.yearFrom || validationErrors.yearRange
                              ? 'border-red-500'
                              : ''
                          }
                        >
                    ...
                    <div className="input-wrapper">
                      <Select
                        ...
                        onValueChange={value =>
                          handleYearChange('yearTo', value === 'year-to' ? '' : value)
                        }
                      >
                        <SelectTrigger
                          className={
                            validationErrors.yearTo || validationErrors.yearRange
                              ? 'border-red-500'
                              : ''
                          }
                        >
