...
const NavigationSimple = () => {
  ...
  const onMPDetail =
    location.pathname.startsWith('/mplads/mps/') && location.pathname !== '/mplads/mps'
  ...
  return (
    <>
          ...
          >
            ...
            {!onMPDetail && (
              <>
                ...
                >
                  <label
                    htmlFor="ls-term-select"
                    style={{ fontSize: '0.8125rem', color: '#4a5568' }}
                  >
                    LS Term
                  </label>
                  <select
                ...
                {utilityItems.map(item => (
                  ...
                  >
                    ...
                    <div>
                      <div style={{ fontWeight: 500, fontSize: '0.9375rem' }}>{item.title}</div>
                      <div
                        style={{ fontSize: '0.8125rem', color: '#6b7280', marginTop: '0.125rem' }}
                      >
                        {item.description}
                      </div>
                    </div>
      ...
      >
        ...
        >
          <li>
            <Link to="/" style={{ color: '#4a5568', textDecoration: 'none' }}>
              Home
            </Link>
          </li>
          <li style={{ color: '#a0aec0' }}>/</li>
          <li>
            <Link to="/mplads" style={{ color: '#4a5568', textDecoration: 'none' }}>
              MPLADS
            </Link>
          </li>
            ...
            <>
              ...
              <li style={{ color: '#2c5282', fontWeight: 500 }}>
                {(() => {
                  ...
                  if (
                    location.pathname.startsWith('/mplads/mps/') &&
                    location.pathname !== '/mplads/mps'
                  ) {
                    return 'Member'
                  }
                  if (
