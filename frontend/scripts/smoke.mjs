/*
  ...
  Usage:
  API_URL=http://localhost:8080/api npm run smoke
  or
  npm run smoke  (defaults to http://localhost:8080/api)
*/

const BASE = process.env.API_URL?.replace(/\/$/, '') || 'http://localhost:8080/api'
